...
# ----------------- CONFIG -----------------
API_ID = int(os.environ.get("TG_API_ID", "27886959"))
API_HASH = os.environ.get("TG_API_HASH", "49da48b1ea0ea4121950cec22685081e")
...
BOT_CREATOR = os.environ.get("BOT_CREATOR", "@your_handle")   # set to your credit text if you want
